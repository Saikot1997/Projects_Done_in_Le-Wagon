...
class Order:
    ...
    def get_training_data(self,
        ...
        # $CHALLENGIFY_END
    def get_review_cost(self):
        #"""Returns a DataFrame with order_id and review_cost columns"""
        # $CHALLENGIFY_BEGIN
        reviews = self.data['order_reviews']
        reviews.loc[:, 'review_cost'] = 0
        reviews.loc[reviews['review_score'].isin([1, 2]), 'review_cost'] = 100
        reviews.loc[reviews['review_score'] == 3, 'review_cost'] = 50
        return reviews[['order_id', 'review_cost']]
